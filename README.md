...
This project is developed for `Ubuntu 20.04` with `ROS Melodic`. Be sure your system has the same configuration. You can check the following links to install them:
...
#### Bonus: Docker container setup (Bypass this section and continue from "2.2. [Installing dependencies](#installing_dependencies)" if you have a successful installation of `Ubuntu 20.04` with `ROS Melodic`)
